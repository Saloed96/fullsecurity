...
public class JwtTokenVerifier extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            List<Map<String, String>> authorities = (List<Map<String, String>>) body.get(jwtConfig.getAuthorities());
            Set<SimpleGrantedAuthority> authoritySet = authorities.stream()
                .map(map -> new SimpleGrantedAuthority(map.get(jwtConfig.getAuthority())))
